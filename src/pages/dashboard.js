...
import { getParents, numberParentByMonth } from "backend-utils/parent-utils";
...
const Dashboard = () => {
  ...
  if (user == null) {
    ...
    useEffect(() => {
      ...
      // Get the number of students by grade
      ...
      // Get the number of parents by month
      numberParentByMonth(token)
        .then((res) => res.json())
        .then((data) => {
